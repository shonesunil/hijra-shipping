    ...
    <div :class="navClass" class="font-raleway text-lg md:text-sm px-4 py-3 md:px-24 md:py-6 bg-white border-b border-gray-200 sticky top-0 z-30">
        <nav class="md:flex md:items-center md:justify-between">
            <div class="flex justify-between items-center">
                <router-link @click="toggleBurgerForImage" id="homeImg" to="/">
                    <img class="w-24 md:w-36 h-auto" id="logo" src="../assets/Hijra_Logo1.png" alt="logo">
                </router-link>
            ...
            <ul class="md:flex md:items-center border-t-[0.5px] pt-5 md:pt-0 border-[#D6D6D6] md:border-0 px-4 md:px-0 z-[-10] md:z-30 md:static absolute bg-white md:bg-inherit text-black w-full left-0 md:w-auto md:opacity-100 opacity-0 top-[-400px] drop-shadow md:drop-shadow-none">
                ...
                <li class="pb-5 md:px-3 big:px-5 md:py-3" :class="{ 'md:border-b border-black': $route.path === '/services' }" @mouseover="mouseOverToggle" @mouseout="mouseOutToggle">
                    <router-link @click="toggleBurger" class="" to="/services">
                        Our Services
                    </router-link>
                    ...
                    <div v-show="dropdownOpen" ref="dropDiv" class="md:absolute mt-5 md:mt-[13px] w-[215px] bg-white md:border-[0.5px] md:border-[#D2D2D2] md:shadow-md flex flex-col rounded-b-lg overflow-hidden">
                        <router-link @click="toggleBurger" class="px-5 pb-3 md:py-3 md:hover:font-medium md:hover:bg-[#E6E6E6]" to="/services/transportation">Transportation</router-link>
                        <router-link @click="toggleBurger" class="px-5 py-3 md:hover:font-medium md:hover:bg-[#E6E6E6]" to="/services/freight">Freight (Sea/Air)</router-link>
                        <router-link @click="toggleBurger" class="px-5 py-3 md:hover:font-medium md:hover:bg-[#E6E6E6]" to="/services/contract-logistics">Contract Logistics</router-link>
                        <router-link @click="toggleBurger" class="px-5 py-3 md:hover:font-medium md:hover:bg-[#E6E6E6]" to="/services/custom-clearance">Custom Clearance</router-link>
                        <router-link @click="toggleBurger" class="px-5 pt-3 md:py-3 md:hover:font-medium md:hover:bg-[#E6E6E6]" to="/services/warehousing">Warehousing</router-link>
                    </div>
                </li>
