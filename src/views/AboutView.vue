<template>
  <div class="pt-4 md:pt-28 pb-16 md:pb-36 bg-gray-100 px-4 md:pl-24 md:pr-0 font-raleway flex-col-reverse md:flex-row flex justify-between">
    <div class="basis-7/12 pt-14 md:py-14 md:mr-14 lg:mr-20"> 
      <span class="font-playfair font-semibold text-5xl">About Us</span>
      <hr class="border-black my-7 w-36">
      <div class="text-lg font-light text-justify">
    ...
    <div class="basis-5/12 flex flex-nowrap overflow-x-auto shrink-0 md:grid md:grid-rows-3 md:grid-flow-col md:gap-2.5">
        <div class="shrink-0 h-[85vh] w-full mr-2 md:mr-0 md:w-auto md:h-auto md:row-span-1">
          <img class="w-full h-full object-cover" src="../assets/about-us/about-us-1.jpeg" alt="">
        </div>
        <div class="shrink-0 h-[85vh] w-full mr-2 md:mr-0 md:w-auto md:h-auto md:row-span-2">
          <img class="w-full h-full object-cover" src="../assets/about-us/about-us-2.png" alt="">
        </div>
        <div class="shrink-0 h-[85vh] w-full mr-2 md:mr-0 md:w-auto md:h-full md:row-span-3">
